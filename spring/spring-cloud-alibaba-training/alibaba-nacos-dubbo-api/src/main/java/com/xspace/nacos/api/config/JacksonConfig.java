...
import com.xspace.nacos.api.util.JacksonUtil;
  ...
  public Jackson2ObjectMapperBuilderCustomizer customizer() {
    return builder -> {
      ...
      javaTimeModule.addDeserializer(LocalDateTime.class, new LocalDateTimeDeserializer(DateTimeFormatter.ofPattern(
              "yyyy-MM-dd HH:mm:ss")));
      javaTimeModule.addDeserializer(LocalDate.class, new LocalDateDeserializer(DateTimeFormatter.ofPattern("yyyy-MM" +
              "-dd")));
